...
def validate_duration(duration_str):
    ...
    try:
        ...
        print("Chyba: Nesprávn formát doby, správný formát je ´minuty sekundy´ (např. ´30 0´).")
        sys.exit(1)

def calculate_delivery_time(order_time_str, acceptance_duration_str, preparation_duration_str, delivery_duration_str):
    
    # Vypočítává očekávaný čas doručení jídla na základě zadaného času objednávky a dob trvání jednotlivých kroků.end=
